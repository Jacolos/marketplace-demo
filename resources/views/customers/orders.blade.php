...
@section('title', 'Zamówienia - ' . $customer->company_name)
...
<div class="container mx-auto px-4">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mt-2">Zamówienia: {{ $customer->company_name }}</h1>
    </div>
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                            ...
                            <div class="text-xs text-gray-500">
                                {{ $order->items->sum('quantity') }} szt łącznie
                            </div>
                        </div>
                    </td>
